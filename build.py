# -*- coding: utf-8 -*-
"""
Generator fuer die Unterseiten des Muyres-Relaunch-Demonstrators.
Erzeugt alle Subpages mit gemeinsamem Chrome (Nav/Menue/Footer/Cookie/Demo identisch
...
JSONLD = ('<script type="application/ld+json">{"@context":"https://schema.org",'
          ...
          '"address":{"@type":"PostalAddress","streetAddress":"Beethovenstrasse 55",'
          '"postalCode":"41061","addressLocality":"Moenchengladbach","addressCountry":"DE"},'
          '"areaServed":"Moenchengladbach","founder":{"@type":"Person","name":"Michael Muyres"},'
...
def nav(active):
    ...
    return (
        ...
        '    <a class="btn btn--outline nav__cta" href="kontakt.html">Erstgespraech</a>\n'
        '    <a class="nav__mcontact" href="kontakt.html">Kontakt</a>\n'
        '    <button class="nav__burger" id="burger" aria-label="Menue oeffnen" aria-expanded="false"><span></span><span></span><span></span></button>\n'
        '  </div>\n</header>\n\n'
...
'          <span>Beethovenstrasse 55</span>\n          <span>41061 Moenchengladbach</span>\n        </div>\n      </div>\n'
'      <div>\n        <h4>Kontakt</h4>\n        <div class="footer__row">\n'
...
'      <span><a href="impressum.html">Impressum</a> &nbsp;|&nbsp; <a href="datenschutz.html">Datenschutz</a> &nbsp;|&nbsp; <a href="#" id="cookieReopen">Cookies</a> &nbsp;|&nbsp; <a href="hinweise.html">Ueber diesen Entwurf</a></span>\n    </div>\n  </div>\n</footer>\n')

TAIL = (
'<div class="cookie hidden" id="cookie" role="dialog" aria-label="Cookie-Hinweis" aria-modal="false">\n'
'  <p class="cookie__text"><strong>Wir verwenden Cookies.</strong> Wir nutzen Cookies, um Ihnen die bestmoegliche Erfahrung auf unserer Website zu bieten. Mehr dazu in der <a href="datenschutz.html">Datenschutzerklaerung</a>.</p>\n'
...
'  <button class="demobar__close" id="democlose" aria-label="Hinweis schliessen">&times;</button>\n</div>\n\n'
...
'        <div class="pledge"><h3>Kompetente Beratung auf Augenhoehe</h3></div>\n'
...
# ---------------- Fachgebiete ----------------
FG = {
 "unternehmen": ("Unternehmen", "Steuerberatung fuer Unternehmen in Moenchengladbach: Jahresabschluss, Lohnbuchhaltung, betriebliche Steuererklaerung und laufende Beratung.",
   "Gerade als Unternehmen gibt es im Geschaeftsalltag viele Steuerthemen zu beachten. Ob Steuerplanung, Rechnungswesen oder Unternehmensberatung: Wir stehen als Partner an Ihrer Seite und entwickeln gemeinsam eine massgeschneiderte Loesung fuer Ihr Unternehmen.",
   ["Jahresabschluss", "Betriebliche Steuererklaerung", "Begleitung von Unternehmenskaeufen (Asset- oder Share Deal)", "Finanzbuchfuehrung und Lohnbuchhaltung", "Unternehmensnachfolge"]),
 "privatpersonen": ("Privatpersonen", "Steuerberatung fuer Privatpersonen: Einkommensteuererklaerung, Pruefung von Steuerbescheiden und Vermoegensuebertragung.",
   "Von der Steuererklaerung ueber Werbungskosten bis zum Rechtsbehelfsverfahren: Im Steuerrecht wird man als Privatperson mit vielen Themen konfrontiert. Wir helfen Ihnen, den Ueberblick zu bewahren, und ermitteln gezielt Ihr persoenliches Steuersparpotenzial.",
   ["Einkommensteuererklaerung", "Besteuerung sonstiger Einkuenfte, etwa Renten- und Pensionsbezuege", "Pruefung von Steuerbescheiden", "Vermoegensuebertragung (Erbschaftsteuer und Schenkungsteuer)"]),
 "existenzgruender": ("Existenzgruender & Startups", "Steuerberatung fuer Existenzgruender und Startups: Businessplan, Rechtsformwahl, Foerdergelder und Liquiditaetsplanung.",
   "Sie sind Jungunternehmer oder planen ein Startup und benoetigen steuerliche Hilfe bei den ersten Schritten? Wir unterstuetzen Sie bei Finanzierungsanfragen und Bankgespraechen und entwickeln gemeinsam ein Businesskonzept sowie eine Rentabilitaetsvorschau.",
   ["Businessplan", "Liquiditaetsplanung", "Beantragung von Foerdergeldern, etwa Gruendungszuschuss", "Beratung zur Rechtsformwahl", "Jahresabschluss"]),
 "freiberufler": ("Freiberufler & Freelancer", "Steuerberatung fuer Freiberufler und Freelancer: Gewinnermittlung, Finanzbuchfuehrung und betriebliche Steuererklaerung.",
   "Sie arbeiten als Selbststaendiger und benoetigen Hilfe bei Ihren Steuerthemen? Wir analysieren Ihre Ist-Situation und stellen gemeinsam die richtigen Weichen fuer Ihre steuerliche Zukunft.",
   ["Betriebliche Steuererklaerung", "Erstellung von Gewinnermittlungen", "Finanzbuchfuehrung"]),
 "immobilienbesitzer": ("Immobilienbesitzer", "Steuerberatung fuer Immobilienbesitzer: Grundsteuererklaerung, Vermietung und Verpachtung, Bewertung und Vermoegensuebertragung.",
   ...
   ["Grundsteuererklaerung", "Optionsbesteuerung fuer Umsatzsteuer", "Bewertung von Grundstuecken", "Vermietung und Verpachtung", "Vermoegensuebertragung (Erbschaftsteuer und Schenkungsteuer)"]),
}
...
BEN = ["Geregelte Arbeitszeit fuer eine ausgewogene Work-Life-Balance", "Ansprechende, leistungsgerechte Verguetung",
 "Foerderung der individuellen, fachlichen Weiterbildung", "Abwechslungsreiche Taetigkeiten",
 "Wertschaetzende, kollegiale Unternehmenskultur auf Augenhoehe", "Arbeitsplatz im Gruenen direkt am Bunten Garten",
...
'        <h2 class="h2">Verantwortlich fuer diesen Entwurf</h2>\n'
'        <p>Dr.-Ing. Suat Akyol<br>Interim Manager<br>E-Mail: contact@akyol.de</p>\n'
'        <p>Saemtliche Inhalte, Texte, Logos und Fotos stammen von der Steuerberatung Muyres und unterliegen deren Rechten. Sie werden hier ausschliesslich zu Demonstrationszwecken verwendet. Bei Fragen oder auf Wunsch der Kanzlei wird dieser Entwurf umgehend entfernt.</p>\n      </div>\n    </div>\n  </section>\n')
...
'        <p>Lediglich Ihre Cookie-Auswahl und das Ausblenden des Entwurf-Hinweises werden technisch in Ihrem Browser (localStorage) gespeichert. Diese Angaben verlassen Ihr Geraet nicht.</p>\n'
'        <h2 class="h2">Externe Dienste</h2>\n'
'        <p>Es sind keine externen Dienste, Tracking-Tools oder Karten aktiv eingebunden. Das Kontaktformular versendet keine Daten. Externe Links werden ueber eine Zwischenseite geoeffnet.</p>\n'
...
# ---------------- Hinweise (Ueber diesen Entwurf) ----------------
hw = subhero("Ueber diesen Entwurf", "Ueber diesen Entwurf.",
   "Was Sie hier sehen, wie es entstanden ist und was funktioniert.")
hw += ('  <section class="section">\n    <div class="container">\n      <div class="prose narrow reveal">\n'
'        <h2 class="h2">Was ist das?</h2>\n        <p>Ein unverbindlicher Redesign-Entwurf fuer die Steuerberatung Muyres, erstellt von Dr.-Ing. Suat Akyol. Ziel ist es zu zeigen, wie der bestehende Webauftritt in moderner, klarer Form aussehen koennte. Inhalte und Bilder wurden vom Original uebernommen.</p>\n'
'        <h2 class="h2">Was funktioniert, was nicht</h2>\n'
'        <p>Navigation, Layout, Animationen und das responsive Verhalten sind voll funktionsfaehig. Das Kontaktformular versendet keine Daten, Datei-Downloads sind nicht hinterlegt, und externe Links oeffnen ueber eine Zwischenseite.</p>\n'
'        <h2 class="h2">Kontakt</h2>\n        <p>Anmerkungen gerne an Dr.-Ing. Suat Akyol, contact@akyol.de.</p>\n      </div>\n    </div>\n  </section>\n')
write("hinweise", "Ueber diesen Entwurf", "Hinweise zum Redesign-Entwurf der Steuerberatung Muyres von Dr.-Ing. Suat Akyol.", "", hw)

# ---------------- weiter.html (Redirect-Platzhalter) ----------------
wt = subhero("Externer Link", "Sie verlassen den Entwurf.", "")
wt += ('  <section class="section">\n    <div class="container">\n      <div class="prose narrow reveal">\n'
'        <p>Dieser Link fuehrt auf eine externe Seite, die nicht Teil dieses Entwurfs ist.</p>\n'
'        <p id="zielinfo"></p>\n        <p><a class="btn btn--primary" id="zielbtn" href="index.html">Weiter zur externen Seite</a> &nbsp; <a class="btn btn--ghost" href="index.html">Zurueck</a></p>\n      </div>\n    </div>\n  </section>\n'
'  <script>(function(){var p=new URLSearchParams(location.search).get("ziel")||"";try{var u=new URL(p);var ok=/(steuerberatung-muyres\\.de|steuerberatungneumann\\.de|xing\\.com|linkedin\\.com)$/.test(u.hostname);if(ok){document.getElementById("zielbtn").href=u.href;document.getElementById("zielinfo").textContent=u.href;}else{document.getElementById("zielinfo").textContent="Unbekanntes Ziel.";}}catch(e){document.getElementById("zielinfo").textContent="Kein gueltiges Ziel.";}})();</script>\n')
write("weiter", "Externer Link", "Zwischenseite fuer externe Links.", "", wt)

# ---------------- 404 ----------------
nf = subhero("Seite nicht gefunden", "Seite nicht gefunden.", "Die aufgerufene Seite existiert nicht.")
nf += ('  <section class="section">\n    <div class="container">\n      <div class="prose narrow reveal">\n'
'        <p>Vielleicht hilft der Weg zurueck zur <a href="index.html">Startseite</a> oder zu unseren <a href="fachgebiete.html">Fachgebieten</a>.</p>\n      </div>\n    </div>\n  </section>\n')
...
"> Persoenliche Steuerberatung in Moenchengladbach. Gegruendet 2020 von Michael Muyres, am Bunten Garten an der Beethovenstrasse. Leitbild: Tradition trifft Moderne.\n\n"
"Hinweis: Diese Seite ist ein Redesign-Entwurf (Demonstrator) von Dr.-Ing. Suat Akyol, kein offizieller Auftritt der Kanzlei.\n\n"
"## Leistungen\n- Unternehmen: Jahresabschluss, Lohnbuchhaltung, betriebliche Steuererklaerung, Unternehmensnachfolge\n"
"- Privatpersonen: Einkommensteuererklaerung, Pruefung von Steuerbescheiden, Vermoegensuebertragung\n"
"- Existenzgruender und Startups: Businessplan, Rechtsformwahl, Foerdergelder\n"
"- Freiberufler und Freelancer: Gewinnermittlung, Finanzbuchfuehrung\n"
"- Immobilienbesitzer: Grundsteuererklaerung, Vermietung und Verpachtung, Bewertung\n\n"
"## Kontakt\n- Adresse: Beethovenstrasse 55, 41061 Moenchengladbach\n- Telefon: 02161 / 49 50 78 - 0\n- E-Mail: info@steuerberatung-muyres.de\n"
"- Bueurozeiten: Mo-Do 8:30-12:30 und 13:30-16:30 Uhr, Fr 8:30-13:00 Uhr\n\n"
"## Erstgespraech\nKostenfreies Erstgespraech als Telefonberatung, Onlinecoaching oder Termin vor Ort.\n")
